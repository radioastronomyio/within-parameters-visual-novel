...
- `game-design/m3-trait-system-v2.md` (authoritative trait definitions)
...
|------------|-------------|
| [Trait System v2](../game-design/m3-trait-system-v2.md) | Defines all 16 traits, their effects, and the interaction matrix |
