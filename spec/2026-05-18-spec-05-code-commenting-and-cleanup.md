...
| `game-design/m3-trait-system-v2.md` is a pointer, not a copy | File contains only a redirect notice and link to `game-design/m3-trait-system-v2.md` |
...
- `game-design/m3-trait-system-v2.md` → pointer to `game-design/m3-trait-system-v2.md`
